...
<div class="banner-2 flex flex-col xl:flex-row items-center md:justify-evenly" id="about">
    <div>
    <img
    ...
    <div class="flex flex-col md:flex-row  gap-8 md:gap-24" data-page="resume">
