   ...
   <div class="banner-2 space-y-10 pb-20" id="work">
    ...
    <div class="card flex flex-col xl:flex-row">
      ...
      <div class="card-image flex flex-col h-full m-4 pt-12 xl:m-2">
        ...
        <div class="flex gap-8 items-center justify-center">
          <p class="font-bold mt-4 mb-4 text-xs md:text-md text-yellow-500 hover:text-teal-600 bg-black rounded-full  py-2 px-6">
          <a href="https://github.com/giokuan/Plant-Base-Project">SOURCE CODE</a>
        </p>
    ...
    <div class="card flex flex-col xl:flex-row">
      ...
      <div class="card-image flex flex-col h-full m-4 pt-12 xl:m-2">
        ...
        <div class="flex gap-8 items-center justify-center">
          <p class="font-bold mt-4 mb-4 text-xs md:text-md text-yellow-500 hover:text-teal-600 bg-black rounded-full  py-2 px-6">
          <a href="https://github.com/giokuan/BarmmProject">SOURCE CODE</a>
        </p>

        <p class="font-bold mt-4 mb-4 text-xs md:text-md text-yellow-500 hover:text-teal-600 bg-black rounded-full  py-2 px-6">
          <a href="https://www.youtube.com/watch?v=wnPpptOuFwY&t=87s">VIDEO DEMO</a>
        </p>
        </div>
    ...
    <div class="card flex flex-col xl:flex-row">
      ...
      <div class="card-image flex flex-col h-full m-4 pt-12 xl:m-2">
        ...
        <div class="flex gap-8 items-center justify-center">
          <p class="font-bold text-yellow-500 mt-4 mb-4 text-xs md:text-md  hover:text-teal-600 bg-black rounded-full  py-2 px-6">
          <a href="https://github.com/giokuan/The-Lazy-Reader-Limited">SOURCE CODE</a>
        </p>
